program bresenhamrondwithtwoobjectsandstoponproximity;
...
begin
  ...
  InitWindow(800, 600, 'Moving Objects with Stop on Proximity Detection');

  // Initialisation de l'objet 1
  obj1.x := 50; obj1.y := 100;
  obj1.targetX := 300; obj1.targetY := 125;
  obj1.speed := 10;
