...
var
  mouseX, mouseY, colorIndex, xPos, yPos: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        // Appliquer la couleur et le numéro du petit carré au grand carré sélectionné
        Cells[SelectedLargeRow, SelectedLargeCol].Color := Colors[colorIndex];
        Cells[SelectedLargeRow, SelectedLargeCol].Number := colorIndex;
      end;
    end;
  end;
end;
