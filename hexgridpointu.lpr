...
const
  ...
  HexWidth = HexDiameter;       // Largeur totale d'un hexagone pour tête pointue
  HexHeight = HexRadius * sqrt(3);  // Hauteur totale d'un hexagone (pour tête pointue)
...
begin
  for k := 0 to 5 do
  begin
    angle_deg := 60 * k + 30;  // Rotation pour un hexagone tête pointue (ajout de 30°)
