...
const
  ...
  HexWidth = HexRadius * sqrt(3);  // Largeur totale d'un hexagone (distance entre deux sommets opposés pour tête pointue)
  HexHeight = HexDiameter;      // Hauteur de l'hexagone
...
begin
  for k := 0 to 5 do
  begin
    angle_deg := 60 * k;  // Rotation pour hexagone tête pointue
