...
program bresenhamrondwithtwoobjectsandcircle;
...
begin
  ...
  InitWindow(800, 600, 'Moving Objects With Point Storage');
  ...
  begin
    ...
    // Dessiner les objets actuels (représentés par des cercles)
