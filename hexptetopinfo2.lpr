pprogram hexpointtop_corrected_neighbors_full;
...
var
  InfoText: String;
begin
  DrawRectangle(WindowWidth - InfoBoxWidth, 0, InfoBoxWidth, 200, LIGHTGRAY); // Cadre de fond
  DrawRectangleLines(WindowWidth - InfoBoxWidth, 0, InfoBoxWidth, 200, DARKGRAY); // Contour
...
begin
  ...
  begin
    ...
    DrawHexGrid();
    DrawHexInfoBox(); // Affiche les informations du cadre
    EndDrawing();
  end;
