...
begin
  ...
  begin
    ...
    begin
      ...
      Cells[SelectedLargeRow, SelectedLargeCol].HasRoad := not Cells[SelectedLargeRow, SelectedLargeCol].HasRoad;
...
begin
  ...
  RouteButtonRec := RectangleCreate(screenWidth - 180, screenHeight - 100, ButtonWidth, ButtonHeight);
