...
const
  ...
  rows = 7;                       // Nombre d'hexagones en hauteur
  ...
  CoinIn=true;                     // extremement important, si celui est false alors case 1 = extremegauche, sinon decalé par rapport à la 2eme ligne
