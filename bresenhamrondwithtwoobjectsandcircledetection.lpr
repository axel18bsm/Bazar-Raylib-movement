program bresenhamrondwithtwoobjectsandcircledetection;
...
begin
  ...
  begin
    ...
    // Placer l'objet exactement à la position de la cible
    obj.x := obj.targetX;
    obj.y := obj.targetY;
  end
...
begin
  ...
  InitWindow(800, 600, 'Moving Objects with Proximity Detection');
